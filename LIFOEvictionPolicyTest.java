public class LIFOEvictionPolicyTest {
    public static void main(String[] args) {
        Cache<String, String> cache = new CacheImpl<>(3, new LIFOEvictionPolicy<>());
        ...
        // Test 5: LIFO Eviction policy
        cache.clear();
        cache.put("key1", "value1");
        cache.put("key2", "value2");
        cache.put("key3", "value3");
        
        //this should evict key3 since that is the last inserted key and hence this print statement should be null
        cache.put("key4", "value4");
        assert cache.get("key3") == null : "LIFO Eviction policy failed";
        System.out.println("Test 5 - key3 should be evicted: " + cache.get("key3"));
    }
}
